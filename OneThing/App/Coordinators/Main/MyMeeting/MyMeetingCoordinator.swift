//
//  MyMeetingCoordinator.swift
//  OneThing
//
//  Created by 윤동주 on 8/16/25.
//

import SwiftUI

@Observable
final class MyMeetingCoordinator: OTBaseCoordinator {

    private var myMeetingEditStore: MyPageEditStore
    private var myMeetingEditStoreForBinding: Binding<MyPageEditStore> {
        Binding(
            get: { self.myMeetingEditStore },
            set: { self.myMeetingEditStore = $0 }
        )
    }
